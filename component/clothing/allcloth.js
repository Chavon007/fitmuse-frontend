...
export default function Allproduct() {
  ...
  const allProduct = products.filter((product) =>
    [43, 51, 49,  55, 44, 52, 56, 40].includes(product.id)
  );
  return (
    <div className="tops">
      ...
      <Link className="clothinglink" href="/cart"><FaArrowRight/> <span>Click here to vist our store for more products</span></Link>
    </div>
  );
}
